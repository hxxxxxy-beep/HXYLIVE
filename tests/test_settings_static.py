...
class SettingsStaticTests(unittest.TestCase):
    ...
    def test_tests_center_covers_local_diagnostics(self):
        ...
        self.assertIn("Chaturbate and Stripchat should expose account login", js)
        self.assertIn("Chaturbate and Stripchat should expose remote sync", js)
    ...
    def test_media_page_has_profile_filter_and_continuous_playback(self):
        ...
        self.assertIn("media.js?v=hxylive", html)
        ...
        self.assertIn("MAC_HELPER_BASE + '/open'", js)
        self.assertIn("MAC_HELPER_BASE + '/delete'", js)
