...
class TwitchCategoryCatalogTests(unittest.TestCase):
    ...
    def test_content_item_helper(self):
        item = twitch_content_category_item("33214", "Fortnite")
        self.assertEqual("game:33214", item["canonical_key"])
        self.assertEqual("Fortnite", item["display_label"])
