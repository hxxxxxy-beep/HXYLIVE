...
class ProviderRegistryTests(unittest.IsolatedAsyncioTestCase):
    def test_builtin_registry_includes_supported_sources(self):
        ...
        self.assertEqual({"twitch", "chaturbate", "bilibili", "stripchat", "youtube"}, registry.source_types())
        self.assertEqual(
            {"twitch", "chaturbate", "bilibili", "stripchat", "youtube"},
            {
        ...
        self.assertTrue(youtube.capabilities.can_discover)
        self.assertTrue(youtube.capabilities.can_stream)
        self.assertTrue(youtube.capabilities.can_record)
        self.assertTrue(youtube.capabilities.can_follow)
        self.assertTrue(youtube.capabilities.can_login)
        self.assertTrue(youtube.capabilities.can_sync_following)
        self.assertFalse(youtube.capabilities.can_password_login)
        self.assertTrue(youtube.capabilities.uses_ytdlp)
