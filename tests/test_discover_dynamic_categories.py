...
class DiscoverCategoryApiMappingTests(unittest.TestCase):
    ...
    def test_future_content_mapping_is_not_gender(self):
        ...
        youtube_cat = _request_mapping_for("content", "video_category:20")
        self.assertEqual("video_category_id", youtube_cat["request_param"])
        self.assertEqual("20", youtube_cat["request_value"])
        self.assertEqual("content", youtube_cat["filter_scope"])
        self.assertNotEqual("gender", youtube_cat["request_param"])

        youtube_asmr = _request_mapping_for("content", "live_query:asmr")
        self.assertEqual("live_query", youtube_asmr["request_param"])
        self.assertEqual("asmr", youtube_asmr["request_value"])
        self.assertEqual("content", youtube_asmr["filter_scope"])
        self.assertNotEqual("gender", youtube_asmr["request_param"])
...
class DiscoverDynamicCategoriesStaticTests(unittest.TestCase):
    def test_html_uses_category_filters_not_fixed_five_keys(self):
        ...
        self.assertIn("discover_categories.js?v=", html)
        self.assertIn("discover.js?v=", html)
