...
class ConvertStreamSelectionTests(unittest.TestCase):
    ...
    def test_hevc_needs_h264_transcode_for_mac(self):
        self.assertTrue(_codec_needs_h264_transcode("hevc"))
        self.assertTrue(_codec_needs_h264_transcode("h265"))
        self.assertFalse(_codec_needs_h264_transcode("h264"))
        self.assertFalse(_codec_needs_h264_transcode(""))
...
class ConvertOutputSafetyTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def _run_conversion(self, process):
        ...
        with (
            ...
            patch(
                "app.tasks.convert._primary_video_codec_name",
                new=AsyncMock(return_value="h264"),
            ),
